      ...
      <div className="bg-black text-white min-h-screen">
        ...
        <header className="bg-gray-900 text-white py-10 text-center">
          ...
          <p className="text-md mt-2 text-gray-300">
            Learn how Revision uses cookies and similar technologies to enhance your browsing experience.
          </p>
        </header>
        ...
        <main className="max-w-5xl mx-auto px-6 py-16 space-y-16">
          {/* What Are Cookies? */}
          <section>
            <h2 className="text-3xl text-white font-semibold mb-6">What Are Cookies?</h2>
            <p className="text-gray-400 text-md leading-relaxed">
              Cookies are small data files stored on your device when you visit websites. They help improve functionality, analyze usage, and deliver personalized content. Revision uses cookies to enhance performance and tailor your experience.
            </p>
            <p className="text-gray-400 text-md leading-relaxed mt-5">
          ...
          {/* How We Use Cookies */}
          <section>
            <h2 className="text-3xl text-white font-semibold mb-6">How We Use Cookies</h2>
            <p className="text-gray-400 text-md leading-relaxed">
              At Revision, we use cookies for a variety of purposes, including:
            </p>
            <ul className="list-disc list-inside text-md text-gray-400 space-y-3 mt-5">
          ...
          {/* Your Choices */}
          <section>
            <h2 className="text-3xl text-white font-semibold mb-6">Managing Cookies</h2>
            <p className="text-gray-400 text-md leading-relaxed">
          ...
          {/* Third-Party Cookies */}
          <section>
            <h2 className="text-3xl text-white font-semibold mb-6">Third-Party Cookies</h2>
            <p className="text-gray-400 text-md leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl text-white font-semibold mb-6">Changes to This Policy</h2>
            <p className="text-gray-400 text-md leading-relaxed">
              Revision may update this Cookies Policy from time to time. We encourage you to review this page periodically for any changes. Your continued use of our site signifies your agreement to the updated terms.
            </p>
          </section>
        </main>
      </div>
